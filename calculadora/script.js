...
function calcular(event) {
  if (
    ...
    !isNaN(visor.innerHTML)
  ) {
    visor.innerHTML = calculoOperacao(
      valorSalvo,
      operacaoSalva,
      Number(visor.innerHTML)
    );
...
function cliqueTecla(event) {
  ...
  if (
    ...
    visor.innerHTML = visor.innerHTML.replace(visor.innerHTML[visor.innerHTML.length - 1], "")
  }
